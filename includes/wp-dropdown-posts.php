...
/*
Plugin: WP Dropdown Posts v0.2
URI: http://takien.com/661/wp-dropdown-posts-plugins.php
Descr: So you want to list your post in dropdown? Here we go... Paste this code somewhere in your theme file code: <em>&lt;?php wp_dropdown_posts('sort_column=post_date&sort_order=DESC&number=5<strong>&cut_word=1&cut_limit=20&cut_replacement=...</strong>'); ?&gt;</em>. Bold args are NEW feature in version 0.2, in order to cut long titles.
